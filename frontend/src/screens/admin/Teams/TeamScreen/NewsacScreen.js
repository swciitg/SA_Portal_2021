...
const NewsacScreen = () =>{
    ...
    return (
        <>
            <h1 className="text-3xl text-black pb-6">New Sac Members</h1>

            <div className="mt-6">
            <Link
                className="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded"
                to={`${BASEURL}/admin/team/newsac/add`}
            >
                Add Members
            </Link>
            </div>
                        ...
                        {teams.map(
                            ...
                            return (
                                ...
                                <td className="text-center py-3 px-4">
                                    ...
                                    <div>
                                        <img style={{'width': '100px', 'height':'100px'}} src={`${BASEAPI}/team/newsac/${_id}`}
                                            alt=" image" />
                                    </div>
                                </td>
                                ...
                                <td className="text-left py-3 px-4">
                                    <Link
                                    to={{
                                        pathname: `${BASEURL}/admin/team/newsac/${_id}`,
                                        formData: {
                                            name,
                                            email,
                                            contactNo,
