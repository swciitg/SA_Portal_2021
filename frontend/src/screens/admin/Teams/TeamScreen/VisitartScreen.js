...
const NewsacScreen = () =>{
    ...
    return (
        <>
            <h1 className="text-3xl text-black pb-6">Visiting Artist-in-residence Members</h1>

            <div className="mt-6">
            <Link
                className="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded"
                to={`${BASEURL}/admin/team/visitart/add`}
            >
                Add Members
            </Link>
            </div>
                        ...
                        {teams.map(
                            ...
                            return (
                                ...
                                <td className="text-center py-3 px-4">
                                    ...
                                    <div>
                                        <img style={{'width': '100px', 'height':'100px'}} src={`${BASEAPI}/team/visitart/${_id}`}
                                            alt=" image" />
                                    </div>
                                </td>
                                ...
                                <td className="text-left py-3 px-4">
                                    <Link
                                    to={{
                                        pathname: `${BASEURL}/admin/team/visitart/${_id}`,
                                        formData: {
                                            name,
                                            email,
                                            contactNo,
